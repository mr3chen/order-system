 ...
 *
 */
package com.order.system.cacheService.config;
...
import com.order.system.cacheService.common.exception.CacheServiceException;
...
public class ExceptionHandlers {
	...
	protected ServiceResult serverExceptionHandler(final Exception exception) {
		...
		String message;
		if (exception instanceof CacheServiceException) {
			CacheServiceException customerServiceException = (CacheServiceException) exception;
