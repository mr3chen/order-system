 ...
 *
 */
package com.order.system.accountService.config;
...
import com.order.system.accountService.common.exception.TccServiceException;
...
public class ExceptionHandlers {
	...
	protected ServiceResult serverExceptionHandler(final Exception exception) {
		...
		String message;
		if (exception instanceof TccServiceException) {
			TccServiceException customerServiceException = (TccServiceException) exception;
