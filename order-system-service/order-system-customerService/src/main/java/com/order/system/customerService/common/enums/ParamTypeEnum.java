package com.order.system.customerService.common.enums;
...
import com.order.system.common.exception.SerializerException;

/**
 * Param Type.
 *
 * @author zhonghao(Myth)
 */
...
public enum ParamTypeEnum {
	...
	public static ParamTypeEnum getParamTypeEnumByName(final String name) {
		return Arrays.stream(ParamTypeEnum.values()).filter(e -> e.getName().equals(name) && e.support).findFirst()
				.orElseThrow(() -> new SerializerException(" this  param type can not support!"));
	}
}
